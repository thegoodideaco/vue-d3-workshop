      ...
      children: [
        {
          name:      'Brewer Colors',
          path:      'brewer',
          component: () => import('@/views/resources/BrewerColors.vue')
        },
        {
          name:      'Xenographics',
          path:      'xenographics',
          component: () => import('@/views/resources/xenographics/index.vue')
        },
        {
          name:      'Semiology of Graphics',
          path:      'semiology-of-graphics',
          component: () => import('@/views/resources/semiology/index.vue')
        },
        {
          name:      'UX Principles as Algorithms',
          path:      'ux-principles',
          component: () => import('@/views/resources/uxprinciples/index.vue')
        }
      ]
    },
    demos,
