  ...
  children:  [
    {
      ...
      component: () => import('@/views/examples/parallelcoords/index.vue')
    },
    {
      path:      'scales',
      name:      'Scales',
      component: () => import('@/views/examples/scaling/index.vue')
    },
    {
      path:      'axis',
      name:      'Axis',
    ...
    },
    {
      ...
      component: () => import('@/views/examples/hierarchy/index.vue'),
      children:  [
        {
          path:      'cluster',
          name:      'Clusters',
        ...
        },
        {
          path:      'tree',
          name:      'Tree Layout',
          component: () => import('@/views/examples/hierarchy/tree/index.vue')
        },
        {
          path:      'treemap',
          name:      'Treemap Layout',
